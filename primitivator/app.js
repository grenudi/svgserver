...
let document = new JSDOM("<!DOCTYPE html><p>Hello world</p>").window.document;
...
//TODO input point , rewrite to read from a file
function convert(url,cfg) {
	return new Promise((ok)=>{
		Canvas.original(url, cfg).then(original => go(original, cfg, ok));
	});
...
//NOTE not needed without browser
// function init$$1() {
